...
export const stepsToTypes = pgTable(
  "steps_to_types",
  {
    stepId: uuid("step_id").notNull(),
...
export const child1CreateSchema = z.object(createInsertSchema(child1).shape);
export const child1SelectSchema = z.object(createSelectSchema(child1).shape);
